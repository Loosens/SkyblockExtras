...
public final class ArgsClassGenerator implements IClassGenerator {
   ...
   private void generateIndexedSetter(String var1, String var2, Type[] var3, ClassVisitor var4) {
      ...
      for(byte var14 = 0; var14 < var3.length; ++var14) {
         var5.visitVarInsn(21, 1);
         var5.visitConstant(var14);
         var5.visitJumpInsn(159, var8[var14]);
      }
      ...
      for(var9 = 0; var9 < var3.length; ++var9) {
         ...
         label43: {
            ...
            var10002 = var3[var9].getInternalName();
         }

         Label var15;
         label36: {
            try {
               var10000.visitTypeInsn(var10001, var10002);
               var10000 = var5;
               var10001 = 167;
               if (var10 != null) {
                  var15 = var7;
         ...
         var10000.visitJumpInsn(var10001, var15);
      }
