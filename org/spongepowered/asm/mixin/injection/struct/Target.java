...
public class Target implements Comparable<Target>, Iterable<AbstractInsnNode> {
   ...
   public String getCallbackDescriptor(boolean param1, Type[] param2, Type[] param3, int param4, int param5) {
      // $FF: Couldn't be decompiled
   }
   ...
   public MethodInsnNode findInitNodeFor(TypeInsnNode param1) {
      // $FF: Couldn't be decompiled
   }
