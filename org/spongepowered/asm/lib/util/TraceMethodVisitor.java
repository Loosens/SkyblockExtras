...
public final class TraceMethodVisitor extends MethodVisitor {
   ...
   public AnnotationVisitor visitAnnotation(String var1, boolean var2) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitAnnotation(var1, var2);
      }
   ...
   public AnnotationVisitor visitTypeAnnotation(int var1, TypePath var2, String var3, boolean var4) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitTypeAnnotation(var1, var2, var3, var4);
      }
   ...
   public AnnotationVisitor visitAnnotationDefault() {
      ...
      label17: {
         ...
         var10000 = this.mv.visitAnnotationDefault();
      }

      AnnotationVisitor var2 = var10000;
   ...
   public AnnotationVisitor visitParameterAnnotation(int var1, String var2, boolean var3) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitParameterAnnotation(var1, var2, var3);
      }

      AnnotationVisitor var5 = var10000;
   ...
   public AnnotationVisitor visitInsnAnnotation(int var1, TypePath var2, String var3, boolean var4) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitInsnAnnotation(var1, var2, var3, var4);
      }
   ...
   public AnnotationVisitor visitTryCatchAnnotation(int var1, TypePath var2, String var3, boolean var4) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitTryCatchAnnotation(var1, var2, var3, var4);
      }
   ...
   public AnnotationVisitor visitLocalVariableAnnotation(int var1, TypePath var2, Label[] var3, Label[] var4, int[] var5, String var6, boolean var7) {
      ...
      label17: {
         ...
         var10000 = this.mv.visitLocalVariableAnnotation(var1, var2, var3, var4, var5, var6, var7);
      }

      AnnotationVisitor var9 = var10000;
