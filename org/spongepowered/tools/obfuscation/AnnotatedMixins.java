...
final class AnnotatedMixins implements IMixinAnnotationProcessor, ITokenProvider, ITypeHandleProvider, IJavadocProvider {
   ...
   public String getOption(String var1) {
      ...
      return this.getProperties().getProperty(var1);
   }
   ...
   private IMixinAnnotationProcessor$CompilerEnvironment detectEnvironment(ProcessingEnvironment var1) {
      try {
         if (var1.getClass().getName().contains("jdt")) {
   ...
   public void onPassCompleted(RoundEnvironment var1) {
      ...
      label46: {
         try {
            if (var1.processingOver()) {
               var10000 = this.mixins.values();
               break label46;
            }
         } catch (NullPointerException var6) {
            throw b(var6);
         ...
         var10000 = this.mixinsForPass;
      }

      IMixinValidator$ValidationPass var10001;
      AnnotatedMixin var7;
      for(Iterator var2 = ((Collection)var10000).iterator(); var2.hasNext(); var7.runValidators(var10001, this.validators)) {
         AnnotatedMixin var3 = (AnnotatedMixin)var2.next();

         try {
            var7 = var3;
            if (var1.processingOver()) {
               var10001 = IMixinValidator$ValidationPass.FINAL;
               continue;
            }
         } catch (NullPointerException var5) {
            throw b(var5);
         ...
         var10001 = IMixinValidator$ValidationPass.LATE;
      }
   ...
   public void printMessage(Kind param1, CharSequence param2) {
